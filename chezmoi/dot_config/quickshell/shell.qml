...
ShellRoot {
  ...
  // Host is ~/.config/quickshell (Quickshell.shellDir). `omarchyPath` is still
  // injected into plugins that look for bin/ helpers next to the config.
  ...
  readonly property var builtinShellConfig: ({
    ...
    bar: {
      ...
      layout: {
        ...
        right: [{ id: "omarchy.tray" }, { id: "omarchy.bluetooth" }, { id: "omarchy.network" }, { id: "omarchy.audio" }, { id: "omarchy.monitor" }, { id: "omarchy.power" }]
      }
    },
    plugins: []
  })
