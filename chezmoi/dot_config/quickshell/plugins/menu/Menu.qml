...
Item {
  ...
  property string defaultMenuPath: omarchyPath + "/defaults/menu.jsonc"
  property string userMenuPath: Quickshell.env("HOME") + "/.config/quickshell/menu.jsonc"
  ...
  // user extension at ~/.config/quickshell/menu.jsonc) take
  ...
  function evaluateGuards() {
    ...
    guardProc.collected = ""
    guardProc.command = ["bash", "-lc", Util.withBinPath(script)]
