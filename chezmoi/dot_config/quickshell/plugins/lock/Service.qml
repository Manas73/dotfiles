...
Item {
  ...
  readonly property string currentBackgroundLink: home + "/.config/quickshell/background"
  ...
  Process {
    ...
    command: ["bash", "-c", Quickshell.shellDir + "/bin/omarchy-hyprland-session-locked"]
  ...
  Process {
    id: wakeProcess
    command: ["bash", "-c", Quickshell.shellDir + "/bin/omarchy-system-wake"]
  }

  Process {
    id: blankProcess
    command: ["bash", "-c", Quickshell.shellDir + "/bin/omarchy-brightness-keyboard off; " + Quickshell.shellDir + "/bin/omarchy-brightness-display off"]
  }
