...
Panel {
  ...
  function persistLocation(name, latitude, longitude) {
    if (name && latitude !== null && longitude !== null)
      locationSaveProc.command = [Quickshell.shellDir + "/bin/omarchy-weather-location", "--set", name, latitude + "," + longitude]
    else if (name)
      locationSaveProc.command = [Quickshell.shellDir + "/bin/omarchy-weather-location", "--set", name]
    else
      locationSaveProc.command = [Quickshell.shellDir + "/bin/omarchy-weather-location", "--clear"]
