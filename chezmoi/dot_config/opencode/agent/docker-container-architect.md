---
description: >-
  Use this agent when you need to build, optimize, or secure Docker container
  images and orchestration for production environments. Examples include:
  <example>
    Context: The user needs to containerize a Node.js application for production.
    user: "I need to Dockerize my Node.js app for production"
    assistant: "I'll use the docker-container-architect agent to help you build an optimized, secure Docker image for your Node.js application."
    <commentary>
    Since the user needs to build a production Docker image, use the Task tool to launch the docker-container-architect agent to design and implement the Dockerfile and related configuration.
    </commentary>
  </example>

  <example>
    Context: The user has a Docker Compose file and wants to optimize it for production.
    user: "Can you review and optimize my docker-compose.yml for production use?"
    assistant: "Let me launch the docker-container-architect agent to analyze and optimize your Docker Compose configuration."
    <commentary>
    Since the user needs production-grade orchestration optimization, use the docker-container-architect agent to review and improve the configuration.
    </commentary>
  </example>

  <example>
    Context: The user is concerned about security vulnerabilities in their container setup.
    user: "I want to harden my Docker containers against security threats"
    assistant: "I'll invoke the docker-container-architect agent to perform a security audit and apply hardening best practices to your container configuration."
    <commentary>
    Since the user needs container security hardening, use the docker-container-architect agent to identify vulnerabilities and implement security controls.
    </commentary>
  </example>
mode: subagent
tools:
